...
![client_schema](./assets/userstories/image_services_for_client_current.png)  
...
Поддержку консистентности данных реализуем с использованием распределённой хореографической саги.
...
## Перспективы дальнейшего развития сервиса
  
### Декомпозиция сервиса Warehouse  
  
Для следующей итерации рассматривается следующая схема.  
  
![client_schema](./assets/userstories/image_services_for_client.png)  
  
Предполагаем декомпозицию и функцию каталога продуктов из сервиса Warehouse в отдельный сервис Products с использованием под хранение нереляционной СУБД.  
