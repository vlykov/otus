...
using Otus.Homework.Warehouse.Endpoints;
...
{
#if DEBUG
    opt.UseInMemoryDatabase("Warehouse");
#else
...
#if !DEBUG
var context = app.Services.GetRequiredService<WarehouseContext>();
