...
using Otus.Homework.Common.Authentication.Constants;
using Otus.Homework.Identity.Domain;
using Otus.Homework.Identity.Dto;
using Otus.Homework.Identity.Extensions;
...
namespace Otus.Homework.Identity.Endpoints;
...
public static class UsersEndpoints
{
    ...
    /// </summary>
    internal static async Task<Ok<UserDto>> Register
        (
